...
| 완료 |  충돌처리 + A* 병렬 처리 구조 설계 | 5월 2주차 | 최대 100마리 좀비 동시 처리, ThreadPool및 최적화 적용 예정
| 작성중 | 플레이어-좀비 충돌 처리 및 AI 최적화 및 AI 설계 | 5월 3주차 | 상태 전이 조건 정리 필요
| 시작전 |  총기 피격 처리 및 사망 패킷 처리 | 5월 4주차 | Ray-Sphere 기반 판정 또는 Hitbox 설계
| 시작전 |  좀비 갯수 증가에 대한 최적화 대응 | 6월 1주차 | Object 풀링 및 동적 갱신 처리
