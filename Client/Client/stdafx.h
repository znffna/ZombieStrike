...
#define ROOT_PARAMETER_MATERIAL (ROOT_PARAMETER_OBJECT + 1)
#define ROOT_PARAMETER_CAMERA (ROOT_PARAMETER_MATERIAL + 1)
#define ROOT_PARAMETER_FRAMEWORK (ROOT_PARAMETER_CAMERA + 1)
#define ROOT_PARAMETER_LIGHT (ROOT_PARAMETER_FRAMEWORK + 1)

// Standard Texture
#define ROOT_PARAMETER_TEXTURES (ROOT_PARAMETER_LIGHT + 1)

// SkyCube Texture
#define ROOT_PARAMETER_SKYBOX (ROOT_PARAMETER_TEXTURES + 1)
