...
public class BinaryHierarchicalModelExtract : MonoBehaviour
{
    ...
    void WriteMeshInfo(Mesh mesh)
    {
        ...
        if (!gameObject) strObjectName = "";
        else strObjectName = gameObject.name + ", ";

        Debug.Log("Writing Mesh Info" + strObjectName + mesh.name);
        //Debug.Log("Writing Mesh Info" + mesh.name);
    ...
    void Start()
    {
        ...
        print("Model Binary Write Started");
            print(clips.Length);
        }
